        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block user-dropdown">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{(!empty($user->image))? url('upload/admin_images/'.$user->image):url('upload/no_image.jpeg')}}"
                        alt="Header Avatar">
                    <span class="d-none d-xl-inline-block ms-1">@if (Auth::check()) 
                        {{auth()->user()->name}}
                    @endif</span>
