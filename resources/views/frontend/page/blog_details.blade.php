...
@section('title')
    Blogs Details | Personal Portfolio
@endsection
                ...
                <div class="standard__blog__post">
                    ...
                    <div class="blog__details__content services__details__content">
                        <ul class="blog__post__meta">
                            <li><i class="fal fa-calendar-alt"></i> {{$data->created_at->diffForHumans()}}</li>
                    ...
                    <div class="widget">
                        ...
                        <ul class="sidebar__cat">
                            @foreach ($categories as $item)
                                <li class="sidebar__cat__item"><a href="{{route('catg.blog.details',$item->id)}}">{{$item->name}}</a></li>
                            @endforeach
...
<section class="homeContact homeContact__style__two">
    @include('frontend.section.home_contact')
</section>
<!-- contact-area-end -->
